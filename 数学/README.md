...
刷了很多运用不同数据结构解决的题目后 发现很多题目需要运用简单的数学知识 将这些题目归纳总结到此文件夹下


After solving some topics with different data structure, there are a lot of questions to answer by using simple mathematical knowledge. Therefore, I intend to summarize these topics under this folder
